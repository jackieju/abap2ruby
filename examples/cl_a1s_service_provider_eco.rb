...
require_relative "if_a1s_service_provider_eco.rb"
...
class Cl_a1s_service_provider_eco < Cl_bsa_service_provider_co
   ...
   def if_esf_provider_access_i_modify(*_a,in_change_handler:nil,in_message_handler:nil,in_modifications:nil,_i:nil,_e:nil,_b:nil)
      ...
      super_method(Cl_a1s_service_provider_eco, :if_esf_provider_access_i_modify).call(_i:{
   ...
   def if_esf_provider_access_i_retrieve_root_node_id(*_a,in_bo_node_name:nil,in_node_ids:nil,in_requested_image:If_esf_types::Co_image_transactional_buffer,_i:nil,_e:nil,_b:nil)
      ...
      if lv_skipped == abap_true
         super_method(Cl_a1s_service_provider_eco, :if_esf_provider_access_i_retrieve_root_node_id).call(_i:{
            "in_bo_node_name" => in_bo_node_name,
            "in_node_ids" => in_node_ids,
            "in_requested_image" => in_requested_image,
         }, _e:{
   ...
   def if_esf_provider_init_i_init(*_a,in_provider_context:nil,in_bo_name:nil,inout_preferred_trx_pattern:If_esf_provider_init::Co_tp_save_and_continue,_i:nil,_e:nil,_b:nil)
      ...
      super_method(Cl_a1s_service_provider_eco, :if_esf_provider_init_i_init).call(_i:{
   ...
   def if_esf_provider_interact_ctrl_i_close_session(*_a,session_hand_over:nil,_i:nil,_e:nil,_b:nil)
      ...
      super_method(Cl_a1s_service_provider_eco, :if_esf_provider_interact_ctrl_i_close_session).call(_i:{
   ...
   def if_esf_provider_interact_ctrl_i_do_post_processing(*_a,in_overruling_code:nil,inout_messages:nil,_i:nil,_e:nil,_b:nil)
      ...
      super_method(Cl_a1s_service_provider_eco, :if_esf_provider_interact_ctrl_i_do_post_processing).call(_b:binding)
   ...
   def if_esf_provider_query_i_query(*_a,in_bo_node_name:nil,in_query_name:nil,in_selection_parameters:nil,in_query_options:nil,in_authorization_context:nil,in_message_handler:nil,in_fill_data:space,in_filter_node_ids:nil,in_requested_attributes:nil,in_execute_over_sql:space,_i:nil,_e:nil,_b:nil)
      ...
      super_method(Cl_a1s_service_provider_eco, :if_esf_provider_query_i_query).call(_i:{
         "in_bo_node_name" => in_bo_node_name,
   ...
   def if_esf_provider_transact_ctrl_i_on_after_save_transaction(*_a,in_rejected:nil,inout_messages:nil,_i:nil,_e:nil,_b:nil)
      ...
      super_method(Cl_a1s_service_provider_eco, :if_esf_provider_transact_ctrl_i_on_after_save_transaction).call(_i:{
   ...
   def if_esf_provider_action_i_execute_action(*_a,in_bo_node_name:nil,in_action_name:nil,in_node_ids:nil,in_action_parameters:nil,in_referencing_node_elements:nil,in_change_handler:nil,in_message_handler:nil,_i:nil,_e:nil,_b:nil)
      ...
      super_method(Cl_a1s_service_provider_eco, :if_esf_provider_action_i_execute_action).call(_i:{
         "in_bo_node_name" => in_bo_node_name,
   ...
   def put_messages_into_handler(*_a,in_message_handler:nil,in_messages:nil,_i:nil,_e:nil,_b:nil)
      ...
      #"Messages for ESF Message Handler*/Delegation at present not implemented
      ...
      if @mv_notify_trans_error == abap_true || @mv_notify_any_error == abap_true
         ...
         if lt_messages_handler.isNotINITIAL()
            super_method(Cl_a1s_service_provider_eco, :put_messages_into_handler).call
   ...
   def put_messages(*_a,io_message_handler:nil,it_messages:nil,iv_ignore_wrong_orig_location:abap_false,_i:nil,_e:nil,_b:nil)

      io_message_handler=nil;it_messages=nil;iv_ignore_wrong_orig_location=abap_false;
      if _a && _a.size>0
   ...
   def if_a1s_service_provider_eco_i_add_mapped_messages(*_a,it_message:nil,_i:nil,_e:nil,_b:nil)
   ...
   def if_a1s_service_provider_eco_i_add_mapped_notifications(*_a,is_change_notification:nil,io_change_handler:nil,_i:nil,_e:nil,_b:nil)
   ...
   def if_a1s_service_provider_eco_i_map_change_notifications(*_a,is_change_notification:nil,_i:nil,_e:nil,_b:nil)
   ...
   def if_a1s_service_provider_eco_i_map_put_messages_into_handler(*_a,io_message_handler:nil,it_messages:nil,_i:nil,_e:nil,_b:nil)

      io_message_handler=nil;it_messages=nil;
      if _a && _a.size>0
         io_message_handler=_a[0]
         it_messages=_a[1] if _a.size>1
      end
   ...
   include If_a1s_service_provider_eco
