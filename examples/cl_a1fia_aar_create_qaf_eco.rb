...
require_relative "if_bsa_cb_path.rb"
...
class Cl_a1fia_aar_create_qaf_eco < Cl_a1fia_common_eco
   ...
   def modify_core_bo_from_eco_root(*_a,it_changed_attributes:nil,is_eco_root:nil,io_change_handler:nil,io_message_handler:nil,_i:nil,_e:nil,_b:nil)
      ...
      it_changed_attributes=nil;is_eco_root=nil;io_change_handler=nil;io_message_handler=nil;
      if _a && _a.size>0
   ...
   def if_esf_provider_access_i_check(*_a,in_bo_node_name:nil,in_node_ids:nil,in_check_scope:nil,in_message_handler:nil,_i:nil,_e:nil,_b:nil)
      ...
      if in_bo_node_name != If_a1fia_aar_create_qaf_eco::Co_bo_node.root
         super_method(Cl_a1fia_aar_create_qaf_eco, :if_esf_provider_access_i_check).call
   ...
   def if_esf_provider_access_i_modify(*_a,in_change_handler:nil,in_message_handler:nil,in_modifications:nil,_i:nil,_e:nil,_b:nil)
      ...
      if lt_sub_node_modify.isNotINITIAL()
         super_method(Cl_a1fia_aar_create_qaf_eco, :if_esf_provider_access_i_modify).call
   ...
   def if_esf_provider_access_i_retrieve(*_a,in_bo_node_name:nil,in_node_ids:nil,in_requested_image:If_esf_types::Co_image_transactional_buffer,in_edit_mode:nil,in_requested_attributes:nil,in_message_handler:nil,in_buffer_sync_handler:nil,_i:nil,_e:nil,_b:nil)
      ...
      when If_a1fia_aar_create_qaf_eco::Co_bo_node.root
         ...
         super_method(Cl_a1fia_aar_create_qaf_eco, :if_esf_provider_access_i_retrieve).call(_i:{
   ...
   def if_esf_provider_access_i_retrieve_by_association(*_a,in_bo_name:nil,in_bo_node_name:nil,in_association_name:nil,in_node_ids:nil,in_fill_data:nil,in_fill_failed_source_node_ids:abap_true,in_filter_parameters:nil,in_filtered_attributes:nil,in_requested_image:If_esf_types::Co_image_transactional_buffer,in_edit_mode:nil,in_requested_attributes:nil,in_message_handler:nil,in_buffer_sync_handler:nil,_i:nil,_e:nil,_b:nil)
      ...
      if in_bo_node_name == If_a1fia_aar_create_qaf_eco::Co_bo_node.root
         ...
         super_method(Cl_a1fia_aar_create_qaf_eco, :if_esf_provider_access_i_retrieve_by_association).call
   ...
   def if_esf_provider_access_i_retrieve_default_node_values(*_a,in_bo_node_name:nil,in_node_id_handles:nil,in_association_name:nil,in_association_filter_struct:nil,in_association_filter_attribs:nil,in_source_bo_node_name:nil,in_source_node_id:nil,in_source_node_id_is_handle:nil,in_property_handler:nil,_i:nil,_e:nil,_b:nil)
      ...
      if in_bo_node_name != If_a1fia_aar_create_qaf_eco::Co_bo_node.root
         super_method(Cl_a1fia_aar_create_qaf_eco, :if_esf_provider_access_i_retrieve_default_node_values).call
   ...
   def if_esf_provider_access_i_retrieve_properties(*_a,in_bo_node_name:nil,in_node_ids:nil,in_property_handler:nil,in_property_scope:If_esf_types::Co_property_scope_default,_i:nil,_e:nil,_b:nil)
      ...
      if @mv_eco_root_node_id.isNotINITIAL()
         ...
         when If_a1fia_aar_create_qaf_eco::Co_bo_node.root
            ...
            if @ms_readonly_eco_root.processing_status.processing_status_code.isINITIAL() && is_floorplan_editable(_b:binding) == abap_true
            ...
            if is_floorplan_editable(_b:binding) == abap_false
               begin
               ...
               loop(at:lt_requested_attributes, into:lv_eco_attr_name){
                  ...
                  if @ms_readonly_eco_root.is_period_end_close_triggered == abap_true
                     ...
                     read_table(id:@mt_attribute_map)
                     if lr_attr_map.is_dedicated == abap_true && lr_attr_map.dedicated_exit.is_editable(_b:binding) == abap_false
                        lv_is_read_only_attr = abap_true
                  ...
                  #"Field is not editable in UI or not enabled in core BO, set it to read only"Also if the QAF has been opened from the closing cockpit set all fields to readonly except description
            ...
            super_method(Cl_a1fia_aar_create_qaf_eco, :if_esf_provider_access_i_retrieve_properties).call
   ...
   def if_esf_provider_init_i_init(*_a,in_provider_context:nil,in_bo_name:nil,inout_preferred_trx_pattern:If_esf_provider_init::Co_tp_save_and_continue,_i:nil,_e:nil,_b:nil)
      ...
      super_method(Cl_a1fia_aar_create_qaf_eco, :if_esf_provider_init_i_init).call(_i:{
   ...
   def if_esf_provider_interact_ctrl_i_do_post_processing(*_a,in_overruling_code:nil,inout_messages:nil,_i:nil,_e:nil,_b:nil)
      ...
      super_method(Cl_a1fia_aar_create_qaf_eco, :if_esf_provider_interact_ctrl_i_do_post_processing).call(_i:{
   ...
   def if_esf_provider_subscription_i_on_bo_changed(*_a,in_publisher_bo_name:nil,in_bo_changes:nil,in_change_handler:nil,_i:nil,_e:nil,_b:nil)
      ...
      super_method(Cl_a1fia_aar_create_qaf_eco, :if_esf_provider_subscription_i_on_bo_changed).call(_i:{
   ...
   def if_esf_provider_transact_ctrl_i_on_after_cleanup_transaction(*_a,inout_messages:nil,_i:nil,_e:nil,_b:nil)
      ...
      super_method(Cl_a1fia_aar_create_qaf_eco, :if_esf_provider_transact_ctrl_i_on_after_cleanup_transaction).call(_b:binding)
   ...
   def if_esf_provider_transact_ctrl_i_on_after_save_transaction(*_a,in_rejected:nil,inout_messages:nil,_i:nil,_e:nil,_b:nil)
      ...
      super_method(Cl_a1fia_aar_create_qaf_eco, :if_esf_provider_transact_ctrl_i_on_after_save_transaction).call(_i:{
   ...
   def if_esf_provider_transact_ctrl_i_on_before_save_transaction(*_a,_i:nil,_e:nil,_b:nil)
      ...
      super_method(Cl_a1fia_aar_create_qaf_eco, :if_esf_provider_transact_ctrl_i_on_before_save_transaction).call(_e:{
   ...
   def if_esf_provider_value_set_i_retrieve_code_values(*_a,in_bo_node_name:nil,in_node_id:nil,in_node_id_is_handle:nil,in_attribute_name:nil,in_context_parameters:nil,in_context_attributes:nil,_i:nil,_e:nil,_b:nil)
      ...
      if @mv_eco_root_node_id.isNotINITIAL()
         if in_bo_node_name == If_a1fia_aar_create_qaf_eco::Co_bo_node.root
            ...
            super_method(Cl_a1fia_aar_create_qaf_eco, :if_esf_provider_value_set_i_retrieve_code_values).call
   ...
   def if_esf_provider_value_set_i_retrieve_value_set(*_a,in_bo_node_name:nil,in_node_id:nil,in_node_id_is_handle:nil,in_attribute_name:nil,in_selection_parameters:nil,in_query_options:nil,in_authorization_context:nil,_i:nil,_e:nil,_b:nil)
      ...
      if @mv_eco_root_node_id.isNotINITIAL()
         if in_bo_node_name == If_a1fia_aar_create_qaf_eco::Co_bo_node.root
            ...
            super_method(Cl_a1fia_aar_create_qaf_eco, :if_esf_provider_value_set_i_retrieve_value_set).call
   ...
   def get_task_region_bo_details(*_a,iv_eco_name:nil,_i:nil,_e:nil,_b:nil)
      ...
      ev_has_task_region=ev_eco_root_node_name=ev_bo_name=ev_bo_node_name=nil;
   ...
   def add_mapped_messages_int(*_a,it_message:nil,io_message_handler:nil,_i:nil,_e:nil,_b:nil)
      ...
      it_message=nil;io_message_handler=nil;
      if _a && _a.size>0
         it_message=_a[0]
   ...
   def adjust_messages_int(*_a,ct_message_map:nil,_i:nil,_e:nil,_b:nil)
   ...
   def check_and_fill_sob_comp(*_a,ir_root_modification:nil,io_message_handler:nil,_i:nil,_e:nil,_b:nil)
      ...
      ir_root_modification=nil;io_message_handler=nil;
      if _a && _a.size>0
   ...
   def check_mandatory_attr_filled(*_a,cv_save_rejected:nil,ct_message:nil,_i:nil,_e:nil,_b:nil)

      cv_save_rejected=nil;ct_message=nil;
      if _a && _a.size>0
         cv_save_rejected=_a[0]
         ct_message=_a[1] if _a.size>1
      end
   ...
   def extract_editable_non_init_attr(*_a,is_co_attr_struct:nil,is_node_data:nil,iv_bo_node_name:nil,ct_changed_attributes:nil,_i:nil,_e:nil,_b:nil)

      is_co_attr_struct=nil;is_node_data=nil;iv_bo_node_name=nil;ct_changed_attributes=nil;
      if _a && _a.size>0
         is_co_attr_struct=_a[0]
         is_node_data=_a[1] if _a.size>1
         iv_bo_node_name=_a[2] if _a.size>2
         ct_changed_attributes=_a[3] if _a.size>3
      end
   ...
   def get_eco_core_attr_pair_for_nod(*_a,iv_core_bo_node_name:nil,_i:nil,_e:nil,_b:nil)
      ...
      et_eco_core_attr_pair=et_eco_attr_name=et_core_bo_attr_name=nil;
   ...
   def handle_create_with_ref_actions(*_a,iv_for_cancellation:nil,it_node_id:nil,it_referencing_node_elements:nil,io_change_handler:nil,iv_is_test_run:nil,io_message_handler:nil,_i:nil,_e:nil,_b:nil)
      ...
      iv_for_cancellation=nil;it_node_id=nil;it_referencing_node_elements=nil;io_change_handler=nil;iv_is_test_run=nil;io_message_handler=nil;
      if _a && _a.size>0
      ...
      assert(id:a1fia_aar_create_qaf_eco, o:lines(it_referencing_node_elements) == 1)
   ...
   def handle_dedicated_attr_modific(*_a,cs_root:nil,ct_changed_attr:nil,_i:nil,_e:nil,_b:nil)

      cs_root=nil;ct_changed_attr=nil;
      if _a && _a.size>0
         cs_root=_a[0]
         ct_changed_attr=_a[1] if _a.size>1
      end
   ...
   def handle_notifications(*_a,is_change_notification:nil,io_change_handler:nil,_i:nil,_e:nil,_b:nil)
      ...
      is_change_notification=nil;io_change_handler=nil;
      if _a && _a.size>0
         is_change_notification=_a[0]
   ...
   def handle_root_dedicated_fields(*_a,it_requested_attributes:nil,iv_mode_get_all_dedicated_attr:nil,iv_mode_get_relevnt_maped_attr:nil,iv_mode_fill_dedicted_attr_val:nil,cs_eco_root:nil,_i:nil,_e:nil,_b:nil)

      it_requested_attributes=nil;iv_mode_get_all_dedicated_attr=nil;iv_mode_get_relevnt_maped_attr=nil;iv_mode_fill_dedicted_attr_val=nil;cs_eco_root=nil;
      if _a && _a.size>0
         it_requested_attributes=_a[0]
         ...
         cs_eco_root=_a[4] if _a.size>4
      end
      et_eco_attributes=nil;
   ...
   def populate_eco_root_attr_names(*_a,is_co_attr_struct:nil,ct_eco_node_attributes:nil,_i:nil,_e:nil,_b:nil)

      is_co_attr_struct=nil;ct_eco_node_attributes=nil;
      if _a && _a.size>0
         is_co_attr_struct=_a[0]
         ct_eco_node_attributes=_a[1] if _a.size>1
      end
   ...
   def populate_run_specific_nodes(*_a,_i:nil,_e:nil,_b:nil)
      ...
      begin
         ...
         loop(at:lo_bo_desc.get_bo_node_descriptors(_b:binding), into:lo_bo_node_desc){
            ...
            if lo_bo_node_desc.get_property_value(property_name:If_esf_desc::Co_property_enabled) == abap_true || lo_bo_node_desc.is_property_value_final(property_name:If_esf_desc::Co_property_enabled) == abap_false
   ...
   def prepare_core_val_help_retrieve(*_a,iv_eco_attr_name:nil,iv_eco_node_name:nil,iv_eco_node_id:nil,_i:nil,_e:nil,_b:nil)
      ...
      iv_eco_attr_name=nil;iv_eco_node_name=nil;iv_eco_node_id=nil;
      if _a && _a.size>0
         iv_eco_attr_name=_a[0]
         iv_eco_node_name=_a[1] if _a.size>1
         iv_eco_node_id=_a[2] if _a.size>2
      end
      ev_core_bo_node_name=ev_core_bo_node_id=ev_core_bo_node_id_is_handle=ev_core_bo_attr_name=nil;
   ...
   def query_sob_by_comp_sob(*_a,it_selection_param:nil,it_requested_attr:nil,_i:nil,_e:nil,_b:nil)
      ...
      it_selection_param=nil;it_requested_attr=nil;
      if _a && _a.size>0
         it_selection_param=_a[0]
         it_requested_attr=_a[1] if _a.size>1
      end
      et_data_comp_activation_stat=nil;
   ...
   def set_attr_properties(*_a,it_eco_attr_name:nil,io_property_handler:nil,iv_property_name:nil,iv_property_value:nil,iv_eco_node_id:nil,_i:nil,_e:nil,_b:nil)
      ...
      it_eco_attr_name=nil;io_property_handler=nil;iv_property_name=nil;iv_property_value=nil;iv_eco_node_id=nil;
      if _a && _a.size>0
   ...
   def set_root_dedicated_attributes(*_a,it_requested_attributes:nil,cs_eco_root:nil,_i:nil,_e:nil,_b:nil)

      it_requested_attributes=nil;cs_eco_root=nil;
      if _a && _a.size>0
         it_requested_attributes=_a[0]
         cs_eco_root=_a[1] if _a.size>1
      end
   ...
   def set_node_n_assoc_read_only(*_a,io_property_handler:nil,it_node_ids:nil,iv_node_name:nil,_i:nil,_e:nil,_b:nil)
      ...
      io_property_handler=nil;it_node_ids=nil;iv_node_name=nil;
      if _a && _a.size>0
   ...
   def if_bsa_cb_message_mapping_i_adjust_messages(*_a,inout_messages:nil,_i:nil,_e:nil,_b:nil)
   ...
   def if_bsa_cb_path_i_resolve(*_a,in_path_callback_id:nil,in_node_ids:nil,in_data:nil,in_edit_mode:nil,in_requested_image:nil,in_fill_data:abap_true,in_requested_attributes:nil,in_buffer_mode:nil,_i:nil,_e:nil,_b:nil)

      in_path_callback_id=nil;in_node_ids=nil;in_data=nil;in_edit_mode=nil;in_requested_image=nil;in_fill_data=abap_true;in_requested_attributes=nil;in_buffer_mode=nil;
      if _a && _a.size>0
         in_path_callback_id=_a[0]
         in_node_ids=_a[1] if _a.size>1
         in_data=_a[2] if _a.size>2
         in_edit_mode=_a[3] if _a.size>3
         in_requested_image=_a[4] if _a.size>4
         in_fill_data=_a[5] if _a.size>5
         in_requested_attributes=_a[6] if _a.size>6
         in_buffer_mode=_a[7] if _a.size>7
      end
      out_links=out_data=out_messages=out_sync_notifications=nil;
