class Cl_a1fia_acproerr_qaf_eco < cl_a1fia_common_eco
   ...
   def if_esf_provider_access.retrieve(_i:,_e:)
      ...
      FIELD.SYMBOLS <ls_out_links_applog_rt_2_ovv> TYPE sesf_association_link
      FIELD.SYMBOLS <ls_acprer_root> TYPE if_a1fia_acproerr_qaf_eco.ty_root
      #*.................
      #* Initialization
      #*.................
      ...
      when if_a1fia_acproerr_qaf_eco.co_bo_node.root
         ...
         if lt_acprer_root .isInit( )
            ...
            lt_acprer_root = enrich_retrieved_data (_i:, _e:)
      ...
      if ! ( lt_out_failed_source_node_ids .isNotInit( ) )
         raise cx_fatal_exception.new
...
def if_esf_provider_init.init(_i:,_e:)
   ...
   begin
      ...
      , _e:)
      mo_lcp_task = mo_adaptation_handler.get_lcp (_i:, _e:)
      #*     get a LCP instance of the BO Application Log:
      mo_applog_sp_lcp = mo_adaptation_handler.get_lcp (_i:, _e:)
      mo_lcp_facade = in_provider_context.get_lcp_facade (_i:, _e:)
      #*
      #*      TRY.
   ...
   add_node_for_heuristic_rrnid (_i:, _e:)
   add_node_for_heuristic_rrnid (_i:, _e:)
      ...
      when 'FIA_MASTER_DATA'
         ...
         def enrich_retrieved_data(it_accpe_qaf:=nil,_i:,_e:)
            ...
            if lv_determine_navigation == abap_true
               lr_accpe_qaf.error_cause_ui_ind = determine_rcause_ui_indicator (_i:, _e:)
         ...
         def if_bsa_cb_path.resolve
            ...
            FIELD.SYMBOLS <query_parameter> LIKE if_task.co_query_p_attr.root.query_by_business_object
            assign({:to=><query_parameter>}) case in_path_callback_id
            when 'ROOT_TASK'
               #"defined in BSA metadata read_table({:id=>in_node_ids,
               :into=>ls_node_id,
            :index=>1}) ls_parameter.sign = 'I'
            ...
            begin
               ...
               if ! lt_task_ids .isNotInit( )
                  ...
                  if in_fill_data == abap_true AND lt_task_ids .isInit( )
